...
const AddToList: React.FC<IProps> = ({people,setPeople}) => {
    ...
    return (<div className="AddToList">
        {/* <input type="text" placeholder="Name" className="AddToList-input" value={input.name} onChange={(e) => {}} name="name"/> */}
        ...
        <textarea placeholder="Note" className="AddToList-inout" value={input.note} onChange={handleChange} name="note"/>
